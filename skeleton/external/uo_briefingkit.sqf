/*
    THIS SCRIPT IS ORIGINALLY A PART OF UNITED OPERATIONS BRIEFING KIT
...
UO_loadoutIndex = {
...

    {
        ...
        if (side _x isEqualto _playerSide) then {
            ...
            private _textToDisplay = "";
            {
                ...
                if ((alive _unit) && {((isMultiplayer) && (_unit in playableUnits)) || ((!isMultiplayer) && (_unit in switchableUnits))}) then {
                    ...
                    _textToDisplay = _textToDisplay +
                        format ["<img image='\A3\Ui_f\data\GUI\Cfg\Ranks\%4_gs.paa' width='16' height='16'/> <font face='PuristaBold' size='14' color='%5'>%1 - %2 - %3kg</font><br/>",
                            name _unit,
                            _lobbyName,
                    ...
                    if !(_weaponName isEqualto "") then {
                        ...
                        _textToDisplay = _textToDisplay + format ["<font color='#C0C0C0'>Primary: </font>%1<br/>", _name] + ([_weaponName, primaryWeaponItems _unit] call _getWeaponPicture);
                    };
                    ...
                    if !(_sWeaponName isEqualto "") then {
                        ...
                        _textToDisplay = _textToDisplay + format ["<font color='#C0C0C0'>Launcher: </font>%1<br/>", _name];
                    ...
                    if !(_hWeaponName isEqualto "") then {
                        ...
                        _textToDisplay = _textToDisplay + format ["<font color='#C0C0C0'>Sidearm: </font>%1<br/>", _name];
                    ...
                    _textToDisplay = _textToDisplay + format ["<font color='#C0C0C0'>Magazines and items: </font><font color='#808080'>(Click count for info)</font><br/>", _x];
                    ...
                    _textToDisplay = _textToDisplay + "<br/>____________________________________________________________<br/>";
                    _show = true;
                };
            ...
            if !(_grpText isEqualto "") then {_grpArray set [count _grpArray,["Diary", [groupID _group, _grpText]]]};
        };
    } foreach allGroups;
    ...
    UO_showOrbat = {
...

        {
            if (((side _x) isEqualto (side player)) && {!isNull leader _x} && {(isPlayer leader _x) || !(isMultiplayer)}) then {
                _text = _text + format ["<font size='20' color='#C0C0C0'>%1</font>", groupID _x] + "<br/>";
                {
                    private _unit = _x;
                    private _radios = "";
                    {
